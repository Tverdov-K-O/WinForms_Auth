...
namespace WinForms_Auth.Migrations
{
    ...
    [Migration("20220216164109_add_DateCreate_Book")]
    partial class add_DateCreate_Book
    {
            ...
            modelBuilder.Entity("WinForms_Auth.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2e79771e-1fc1-4045-8f87-dbe04a16832b"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("8672234c-e6d1-4401-b333-ee2923bd8bcf"),
                            Name = "Guest"
                        });
                });
            ...
            modelBuilder.Entity("WinForms_Auth.Data.Entities.User", b =>
                {
                    ...
                    b.Property<Guid>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("8672234c-e6d1-4401-b333-ee2923bd8bcf"));
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ff055b39-28b3-498e-853e-ae022c775366"),
                            Email = "admin@admin.com",
                            Name = "Admin",
                            RoleId = new Guid("2e79771e-1fc1-4045-8f87-dbe04a16832b")
                        });
                });
